...
static const char qt_meta_stringdata_HelloForm[] = {
    "HelloForm\0\0checkcompiler()\0listdevices()\0"
    "openfile()\0compilefile()\0savefile()\0"
    "filename\0project(QString)\0"
};
...
void HelloForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->checkcompiler(); break;
        case 1: _t->listdevices(); break;
        case 2: _t->openfile(); break;
        case 3: _t->compilefile(); break;
        case 4: _t->savefile(); break;
        case 5: _t->project((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
